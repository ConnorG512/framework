...
template <FW::LS::LuaType LuaValue>
[[nodiscard]] std::expected<LuaValue, FW::LS::LuaPullValErr>
FW::LS::Inst::get_value_from_script(const std::string &table_path)
{
  ...
  auto get_value = [this]() -> std::expected<LuaValue, FW::LS::LuaPullValErr>
  {
