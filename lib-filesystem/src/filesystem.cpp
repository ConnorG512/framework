...
[[nodiscard]] std::expected<bool, FW::FS::ExistsErrors> FW::FS::exists(const std::filesystem::path &path_to_item) noexcept
{
...
[[nodiscard]] std::expected<void, FW::FS::ExistsErrors> validate_paths(const std::span<const std::filesystem::path> item_collection) noexcept
{
